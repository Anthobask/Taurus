 ...
 * @method UsersQuery orderByNom($order = Criteria::ASC) Order by the nom column
 * @method UsersQuery orderByPrenom($order = Criteria::ASC) Order by the prenom column
 ...
 * @method UsersQuery orderByAccess($order = Criteria::ASC) Order by the access column
 *
 * @method UsersQuery groupById() Group by the id column
 * @method UsersQuery groupByNom() Group by the nom column
 * @method UsersQuery groupByPrenom() Group by the prenom column
 ...
 * @method UsersQuery groupByAccess() Group by the access column
 *
 ...
 *
 * @method Users findOneByNom(string $nom) Return the first Users filtered by the nom column
 * @method Users findOneByPrenom(string $prenom) Return the first Users filtered by the prenom column
 ...
 * @method Users findOneByAccess(int $access) Return the first Users filtered by the access column
 *
 * @method array findById(int $id) Return Users objects filtered by the id column
 * @method array findByNom(string $nom) Return Users objects filtered by the nom column
 * @method array findByPrenom(string $prenom) Return Users objects filtered by the prenom column
 ...
 * @method array findByAccess(int $access) Return Users objects filtered by the access column
 *
...
abstract class BaseUsersQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `nom`, `prenom`, `login`, `email`, `password`, `access` FROM `users` WHERE `id` = :p0';
        try {
    ...
    public function filterByNom($nom = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UsersPeer::NOM, $nom, $comparison);
    }
    ...
    public function filterByPrenom($prenom = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UsersPeer::PRENOM, $prenom, $comparison);
    }
    ...
    public function filterByAccess($access = null, $comparison = null)
    {
        if (is_array($access)) {
            $useMinMax = false;
            if (isset($access['min'])) {
                $this->addUsingAlias(UsersPeer::ACCESS, $access['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($access['max'])) {
                $this->addUsingAlias(UsersPeer::ACCESS, $access['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UsersPeer::ACCESS, $access, $comparison);
    }
