...
abstract class BaseUsersPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Nom', 'Prenom', 'Login', 'Email', 'Password', 'Access', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nom', 'prenom', 'login', 'email', 'password', 'access', ),
        BasePeer::TYPE_COLNAME => array (UsersPeer::ID, UsersPeer::NOM, UsersPeer::PRENOM, UsersPeer::LOGIN, UsersPeer::EMAIL, UsersPeer::PASSWORD, UsersPeer::ACCESS, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NOM', 'PRENOM', 'LOGIN', 'EMAIL', 'PASSWORD', 'ACCESS', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'nom', 'prenom', 'login', 'email', 'password', 'access', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Nom' => 1, 'Prenom' => 2, 'Login' => 3, 'Email' => 4, 'Password' => 5, 'Access' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nom' => 1, 'prenom' => 2, 'login' => 3, 'email' => 4, 'password' => 5, 'access' => 6, ),
        BasePeer::TYPE_COLNAME => array (UsersPeer::ID => 0, UsersPeer::NOM => 1, UsersPeer::PRENOM => 2, UsersPeer::LOGIN => 3, UsersPeer::EMAIL => 4, UsersPeer::PASSWORD => 5, UsersPeer::ACCESS => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NOM' => 1, 'PRENOM' => 2, 'LOGIN' => 3, 'EMAIL' => 4, 'PASSWORD' => 5, 'ACCESS' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'nom' => 1, 'prenom' => 2, 'login' => 3, 'email' => 4, 'password' => 5, 'access' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsersPeer::NOM);
            $criteria->addSelectColumn(UsersPeer::PRENOM);
            ...
            $criteria->addSelectColumn(UsersPeer::ACCESS);
        } else {
