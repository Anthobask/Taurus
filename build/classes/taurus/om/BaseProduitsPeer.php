...
abstract class BaseProduitsPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Nom', 'Prix', 'Description', 'Documenation', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nom', 'prix', 'description', 'documenation', ),
        BasePeer::TYPE_COLNAME => array (ProduitsPeer::ID, ProduitsPeer::NOM, ProduitsPeer::PRIX, ProduitsPeer::DESCRIPTION, ProduitsPeer::DOCUMENATION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NOM', 'PRIX', 'DESCRIPTION', 'DOCUMENATION', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'nom', 'prix', 'description', 'documenation', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Nom' => 1, 'Prix' => 2, 'Description' => 3, 'Documenation' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nom' => 1, 'prix' => 2, 'description' => 3, 'documenation' => 4, ),
        BasePeer::TYPE_COLNAME => array (ProduitsPeer::ID => 0, ProduitsPeer::NOM => 1, ProduitsPeer::PRIX => 2, ProduitsPeer::DESCRIPTION => 3, ProduitsPeer::DOCUMENATION => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NOM' => 1, 'PRIX' => 2, 'DESCRIPTION' => 3, 'DOCUMENATION' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'nom' => 1, 'prix' => 2, 'description' => 3, 'documenation' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
