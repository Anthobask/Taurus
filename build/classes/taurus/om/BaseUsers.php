...
abstract class BaseUsers extends BaseObject implements Persistent
{
    ...
    public function setNom($v)
    {
        ...
        if ($this->nom !== $v) {
            $this->nom = $v;
            $this->modifiedColumns[] = UsersPeer::NOM;
        }
    ...
    public function setPrenom($v)
    {
        ...
        if ($this->prenom !== $v) {
            $this->prenom = $v;
            $this->modifiedColumns[] = UsersPeer::PRENOM;
        }
    ...
    public function setAccess($v)
    {
        ...
        if ($this->access !== $v) {
            $this->access = $v;
            $this->modifiedColumns[] = UsersPeer::ACCESS;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UsersPeer::NOM)) {
            $modifiedColumns[':p' . $index++]  = '`nom`';
        }
        if ($this->isColumnModified(UsersPeer::PRENOM)) {
        ...
        if ($this->isColumnModified(UsersPeer::ACCESS)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsersPeer::NOM)) $criteria->add(UsersPeer::NOM, $this->nom);
        if ($this->isColumnModified(UsersPeer::PRENOM)) $criteria->add(UsersPeer::PRENOM, $this->prenom);
        ...
        if ($this->isColumnModified(UsersPeer::ACCESS)) $criteria->add(UsersPeer::ACCESS, $this->access);
